...
class RSNA24Dataset_Sag_Axial_Cls(Dataset):
    def __init__(self,
        ...
        # self.pred_sag_keypoints_infos_3d_t1_new = pickle.load(
        #     open(f'/home/hw/m2_disk/kaggle/RSNA2024_Lee//infer_scripts//sag_t1_3d_keypoints_v20.pkl', 'rb'))
        # easy_study_ids = pd.read_csv(f'{data_root}/easy_list_0813.csv')['study_id'].tolist()
        # self.easy_study_ids = set(easy_study_ids)

        # self.use_3d_2d_cascade_points = False
        ...
        #     for study_id in self.pred_sag_keypoints_infos_3d.keys():
        #         p = self.pred_sag_keypoints_infos_3d[study_id]['points'].reshape(15, 3)
        ...
        #
        #         self.pred_sag_keypoints_infos_3d[study_id]['points'] = p
        #
        # self.saggital_affine_infos = pickle.load(
        #     open(f'{data_root}/saggital_affine.pkl', 'rb'))
        #
        # self.saggital_t2_rbox_info = build_saggital_t2_rbox(data_root)
