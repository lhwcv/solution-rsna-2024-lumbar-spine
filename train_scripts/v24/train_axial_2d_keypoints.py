...
from train_scripts.v24.axial_data import Axial_2D_Point_Dataset
...
def get_args():
    ...
    parser.add_argument('--save_dir', type=str, default='./wkdir/v24/axial_2d_keypoints/')
...
if args.only_val != 1:
    ...
    for fold, (trn_idx, val_idx) in enumerate(skf.split(range(len(df)))):
        ...
        train_ds = Axial_2D_Point_Dataset(
            data_root,
            df_train,
        ...
        valid_ds = Axial_2D_Point_Dataset(
            data_root,
            df_valid,
