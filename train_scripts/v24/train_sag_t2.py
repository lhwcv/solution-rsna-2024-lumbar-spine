...
def get_args():
    ...
    parser.add_argument('--with_level_lstm', type=int, default=1)

    parser.add_argument('--save_dir', type=str, default='./wkdir/v24/sag_t2/')
    ...
    parser.add_argument('--crop_size_h', type=int, default=64)
