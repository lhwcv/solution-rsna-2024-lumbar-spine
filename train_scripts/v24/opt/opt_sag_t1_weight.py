...
data_root = '/home/hw/m2_disk/kaggle/RSNA2024_Lee/train_scripts/wkdir_final2/v20_cond_t1/'

labels = np.load(f'{data_root}/convnext_small.in12k_ft_in1k_384_z_imgs_3_seed_666_h128_w128/labels.npy')
weights = []
for l in labels:
