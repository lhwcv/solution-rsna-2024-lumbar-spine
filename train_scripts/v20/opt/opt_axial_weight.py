...
data_root = '/home/hw/m2_disk/kaggle/RSNA2024_Lee/train_scripts/wkdir/v24/aixal_cond/'
...
preds_oof_path = [
    f'{data_root}/convnext_small.in12k_ft_in1k_384_z_imgs_5/final_convnext_small.in12k_ft_in1k_384_z_imgs_5_ema.npy',
    f'{data_root}/densenet161_z_imgs_5/final_densenet161_z_imgs_5_ema.npy',
    f'{data_root}/pvt_v2_b1.in1k_z_imgs_5/final_pvt_v2_b1.in1k_z_imgs_5_ema.npy',
    #f'{data_root}/pvt_v2_b2.in1k_z_imgs_5/final_pvt_v2_b2.in1k_z_imgs_5_ema.npy',
...
preds_oof_path_name = [p.split('/')[-1].split('.')[0] for p in preds_oof_path]
